...
(
  ...
  material_unit_id     bigint                        NOT NULL, -- 单位
  material_width       decimal(10, 4)                NULL,     -- 幅宽
  material_weight      decimal(10, 4)                NULL,     -- 纺织克重
  material_size_id     bigint                        NULL,     -- 尺码
  material_price       decimal(10, 2)                NULL,     -- 价格
  material_color       varchar(20)                   NULL,     -- 颜色
  material_description varchar(250)                  NULL,     -- 物料描述
...
(
  ...
  if_main_fabric                   tinyint(1)                 NULL -- 是否主面料
