...
{
    public class ThirdPartDataExchange:Entity<long>
    {
    ...
    public class ThridPartDataExcahngeConfigure:EntityConfigure<ThirdPartDataExchange>{
        protected override void InternalConfigure(EntityTypeBuilder<ThirdPartDataExchange> builder){
