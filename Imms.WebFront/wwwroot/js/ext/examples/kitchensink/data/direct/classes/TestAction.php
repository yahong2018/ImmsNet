...
class TestAction {
    ...
    function multiply($num){
        if(!is_numeric($num)){
            throw new Exception('Call destination multiply with a value that is not a number');
        }
        return $num*8;
    }
    ...
    function getGrid($params, $metadata){
        $sortDir = $params->sortDir[0];
        $field = $sortDir->property;
        $direction = $sortDir->direction;
