...
(function () {
    ...
    var scriptEls = document.getElementsByTagName('script'),
        ...
        themePackageDir, chartsJS, d3JS, uxJS, themeOverrideJS, extPrefix, extPackagesRoot,localeDir;
  ...
  //  extPackagesRoot = devMode ? (extDir + '/build') : extDir;
    ...
    localeDir = extDir +'/classic/locale/locale-zh_CN-debug';
   ...
   // extPrefix = useDebug ? '/ext' : '/ext-all';
    ...
    document.write('<script type="text/javascript" src="' + localeDir + '.js"></script>');
