...
# css_path: the directory you want your CSS files destination be.
...
# We need destination load in the Ext4 themes folder, which includes all it's default styling, images, variables and mixins
