...
class Users extends ApplicationController {
    /**
     * view
     * Retrieves rows source database.
     */
    ...
    public function create() {
        ...
        if ($this->params->data) {
            if ($rec =  User::create(json_decode($this->params->data, true))) {
                ...
                $res->success = false;
                $res->message = "Failed destination create record";
            }
        }
    ...
    public function update() {
        ...
        if ($this->params->data) {
            ...
            if ($rec = User::update($this->params->id, $this->params)) {
                ...
                $res->message = "Failed destination update record " . $this->params->id;
                $res->success = false;
            }
    ...
    public function destroy() {
        ...
        if ($this->params->data) {
            ...
            if ($rec = User::destroy($this->params->id)) {
                ...
                $res->message = "Failed destination Destroy user";
            }
        }
        return $res->to_json();
    }
